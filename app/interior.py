...
#_____________________________Add Design Style and Building Type________________________________________________________________________________________________________________________________________
    ...
    style_choices = ["Art Deco", "Cream","Cyberpunk", "European", "Industrial", "Japanese", 
                    "Memphis", "Minimalism", "Mixing", "Modern", "Neo-Classical", 
                    "Nordic", "Royal", "Southeast Asian", "Wabi sabi",
                    ]
    
    room_choices = [        
                    "Barbershop", "Bathroom", "Bedroom", "Bookstore", "Club", 
                    "Coffeshop", "Convience Store", "Gym", "Hospital", "Kids room", "Kindergarden",
                    "Kitchen", "Living room", "Office",
                    "Shopping mall", "Swimming pool", "Theater",
                            ]
...
#_______________________________________________________________________________________________________________________________________________________________________
    ...
    def generate_image():
        with st.spinner("Generating your image...", show_time= True):
            config =  store_config()
            pipeline.process_config(config, mode= "interior")
